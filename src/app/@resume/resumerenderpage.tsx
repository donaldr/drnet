...
export default function ResumeRenderPage() {
  ...
  const inView = useMemo(() => {
    return inViews.includes("resume");
  }, [inViews]);
  ...
  useEffect(() => {
    resize();
    incrementEventHandlerCount("resize-resumerender");
    window.addEventListener("resize", resize);
    return () => {
      decrementEventHandlerCount("resize-resumerender");
